...
The module import path is `github.com/hjs-spec/sdk-go`, matching the actual repository. Replace the earlier non-resolving `github.com/hjs-spec/jep-sdk-go` path in imports.
